...
async function get_stock_data(stockname) {
    var time = get_time();
    console.log('https://query1.finance.yahoo.com/v8/finance/chart/' + stockname + '?symbol=' + stockname + '&period1=' + time.before + '&period2=' + time.now + '&useYfid=true&interval=1d&includePrePost=true&events=div%7Csplit%7Cearn&lang=en-US&region=US&crumb=s9eQSRza8b8&corsDomain=finance.yahoo.com');
